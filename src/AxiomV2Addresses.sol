...
library AxiomV2Addresses {
    address public constant AXIOM_V2_CORE_ADDRESS =
        0x69963768F8407dE501029680dE46945F838Fc98B;
    address public constant AXIOM_V2_QUERY_ADDRESS =
        0x83c8c0B395850bA55c830451Cfaca4F2A667a983;

    address public constant SEPOLIA_AXIOM_V2_CORE_MOCK_ADDRESS =
        0x69963768F8407dE501029680dE46945F838Fc98B;
    address public constant SEPOLIA_AXIOM_V2_QUERY_MOCK_ADDRESS =
        0x83c8c0B395850bA55c830451Cfaca4F2A667a983;
    ...
    uint256 public constant SEPOLIA_AXIOM_V2_QUERY_MOCK_DEPLOY_BLOCK =
        5_103_063;
    ...
    function axiomV2QueryMockAddress(
        uint64 chainId
    ) public pure returns (address addr) {
        if (chainId == MAINNET_CHAIN_ID) {
            revert ContractDoesNotExistForChainId();
    ...
    function axiomV2CoreMockAddress(
        uint64 chainId
    ) public pure returns (address addr) {
        if (chainId == MAINNET_CHAIN_ID) {
            revert ContractDoesNotExistForChainId();
    ...
    function axiomV2QueryDeployBlock(
        uint64 chainId
    ...
    function axiomV2QueryMockDeployBlock(
        uint64 chainId
    ) public pure returns (uint256 blockNumber) {
        if (chainId == MAINNET_CHAIN_ID) {
            revert ContractDoesNotExistForChainId();
    ...
    function axiomV2CoreDeployBlock(
        uint64 chainId
    ) public pure returns (uint256 blockNumber) {
        if (chainId == MAINNET_CHAIN_ID) {
    ...
    function axiomV2CoreMockDeployBlock(
        uint64 chainId
    ) public pure returns (uint256 blockNumber) {
        if (chainId == MAINNET_CHAIN_ID) {
            revert ContractDoesNotExistForChainId();
